...
Dotfiles repo. Primary focus is Neovim config in `generic-neovim/.config/nvim/`, optimized for JS/TS frontend development. Also includes configs for Hammerspoon, Karabiner, wezterm, zsh, starship, and vifm.
